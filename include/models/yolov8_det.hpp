...
public:
    int batch_size = -1;
    TimeStamp* m_ts = NULL;
    YoloV8_det(std::string bmodel_file, std::vector<std::string> model_class_names, int dev_id = 0, float confThresh = 0.25, float nmsThresh = 0.7){
        ...
        //     }
        // }
        m_class_names = model_class_names;
    ...
    ~YoloV8_det(){
        ...
        // }  
        // bm_dev_free(handle);
        // Keep minimal cleanup or set resources to null
        bmrt = NULL;  // Already handled in destruction function
        // Do NOT call bmrt_destroy/bm_dev_free here
    };
